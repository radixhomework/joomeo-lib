...
public class SessionServices extends AbstractService {

    @Getter
    private final String endpoint = "/session";

    // Can't use lombok annotations when super constructor call is needed.
    public SessionServices(RestTemplate restTemplate, JoomeoApiClient client) {
    ...
    public void createSession() {
        ...
        headers.add(X_PAYLOAD_TYPE.value(), EnumSessionType.MANAGER.getValue());
